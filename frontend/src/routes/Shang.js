          ...
          <div className="w3-third">
            <div className="w3-white w3-text-grey w3-card-4">
              ...
              <div className="w3-container">
                ...
                <p>
                  Physics
                  <FontIcon icon={faHandLizard} className="font-icon-right" />
                </p>
          ...
          <div className="w3-twothird">
            <div className="w3-container w3-card w3-white w3-margin-bottom">
              <h2 className="w3-text-grey w3-padding-16">
                <FontIcon icon={faFaceGrinStars} className="font-icon-large" />
                Research Interests
              </h2>
              <div className="w3-container">
            ...
            <div className="w3-container w3-card w3-white w3-margin-bottom">
              <h2 className="w3-text-grey w3-padding-16">
                <FontIcon icon={faGraduationCap} className="font-icon-large" />
                Education
              </h2>
                ...
                <ol>
                  ...
                  <Paper
                    ...
                    name={[
                      ...
                      <span key="subscript" style={{ fontSize: "12px", lineHeight: "18px" }}>
                        3
                      </span>,
                  ...
                  <Paper
                    href="https://arxiv.org/abs/2111.04145"
                    name="(submitted) Humble planar defects in SiGe nanopillars"
                  ...
                  <Paper
                    ...
                    name={[
                      ...
                      <span key="subscript1" style={{ fontSize: "12px", lineHeight: "18px" }}>
                        0.8
                      </span>,
                      "Si",
                      <span key="subscript2" style={{ fontSize: "12px", lineHeight: "18px" }}>
                        0.2
                      </span>,
                    ]}
